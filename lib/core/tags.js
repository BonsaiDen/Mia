// Documentation Tags ---------------------------------------------------------
// ----------------------------------------------------------------------------
function DocTag(type, id, name, comment) {
    this.type = type;
    this.id = id;
    this.name = name;
...
function PropertyTag(id, name, comment) {
    DocTag.call(this, 'Property', id, name, comment);
}
...
PropertyTag.prototype = {
    ...
    merge: function(other) {
        DocTag.prototype.merge.call(this, other);
    },

    annotate: function(parser) {
        DocTag.prototype.annotate.call(this, parser);
    }
...
function FunctionTag(id, name, comment, params) {
    DocTag.call(this, 'Function', id, name, comment);
    this.params = params;
}
...
function FactoryTag(id, name, comment, params) {
    DocTag.call(this, 'Factory', id, name, comment);
    this.params = params;
}
...
function MethodTag(id, name, comment, params, supers) {
    DocTag.call(this, 'Method', id, name, comment);
    this.params = params;
...
function ClassTag(id, name, comment) {
    DocTag.call(this, 'Class', id, name, comment);
    this.bases = [];
    this.params = [];
    this.statics = [];
    this.members = [];
